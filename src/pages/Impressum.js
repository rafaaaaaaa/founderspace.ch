  ...
  return (
    <div>
      <p className="text-white">
        ...
        <br />FounderSpace at the University of Zurich c/o Impulsfabrik<br />
        Rämistrasse 3 <br />
        8005 Zürich<br />
        Switzerland<br />
        <strong>Email</strong>: contact@founderspace.ch<br />
        <br /><strong>Persons</strong>
        <br />Nikola Kitanovic<br />
        Rafael Estermann<br />
        Junaid Hasan<br />
        Annika Gerber<br /><br />
        <strong>Company Name</strong>: FounderSpace at the University of Zuirhc c/o Impulsfabrik<br />
        ...
        The copyrights and all other rights to content, images, photos or other files on this website belong exclusively to FounderSpace at the University of Zuirhc c/o Impulsfabrik or the specifically named rights holders. The written consent of the copyright holder must be obtained in advance for the reproduction of any elements.
        <br /><br /><strong>Source</strong>: <a className="text-blue" href='https://brainbox.swiss/'>BrainBox Solutions</a></p>
    </div>
  );
}
