...
function Landing() {
  return (
    <div className="max-w-screen-xl flex flex-wrap items-center justify-between h-screen">
      <div className="p-4 flex flex-col gap-6 w-full md:w-2/3 items-center md:items-start fade-up-title">
        <h1 className="text-white text-5xl text-center md:text-start md:text-6xl font-haas">
